...
################################################################################################
#  RMG(Real space multigrid)
class RMGFile(GeometryOutputFile):
    """
    Class for storing the geometrical data for a RMG run and the method
    __str__ that outputs to a .rmg file as a string.
    """
    def __init__(self, crystalstructure, string):
        GeometryOutputFile.__init__(self,crystalstructure,string)
        #
